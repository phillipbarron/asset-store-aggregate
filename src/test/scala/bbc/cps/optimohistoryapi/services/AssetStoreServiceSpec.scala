...
class AssetStoreServiceSpec extends FlatSpec with AppTestUtil with MockitoSugar with BeforeAndAfter {
  ...
  object TestHistoryService extends AssetStoreService {
